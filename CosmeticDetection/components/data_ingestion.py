...
class DataIngestion:
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        logging.info(f"Entered initiate data ingestion method of data ingestion class")
        try:
            ...
            logging.info(f"Exited initiate data ingestion method of data ingestion class")
