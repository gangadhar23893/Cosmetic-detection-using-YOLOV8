...
from CosmeticDetection.entity.config_entity import DataValidationConfig
        ...
        try:
            ...
            for file in all_files :
                if file not in self.data_validation_config.required_files_list:
                    ...
                    with open(self.data_validation_config.valid_data_status_file_dir,"w") as f:
                        f.write(f"validation statsu{validation_status}")
                else:
